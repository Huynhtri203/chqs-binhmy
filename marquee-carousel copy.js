...
const MARQUEE_ITEMS = [
  ...
  },
  {
    type   : 'image',
    src    : 'images/anh1.jpg',
    title  : 'Lễ Ra Quân Năm 2026',
    desc   : 'Toàn đơn vị tập kết tại sân UBND xã sẵn sàng thực hành.',
  },
  {
    type   : 'review',
  ...
  },
  {
    ...
    title  : 'Hành Quân Vượt Địa Hình',
    desc   : 'Phân đội vượt chướng ngại vật trong đêm, nâng cao kỹ năng chiến đấu.',
  },
  {
    type   : 'review',
    quote  : '\"Nhờ hệ thống số hóa, công tác quản lý quân nhân tại xã được minh bạch và hiệu quả hơn trước rất nhiều.\"',
    name   : 'Lê Minh Hải',
    role   : 'Chỉ huy trưởng phân đội',
    avatar : 'images/avatar3.jpg',
  },
  {
    type   : 'image',
    src    : 'images/anh2.jpg',
    title  : 'Tập Bắn Thực Hành AK',
    desc   : 'Dân quân tự vệ thực hành bài bắn theo giáo trình chuẩn.',
  },
  {
    type   : 'review',
